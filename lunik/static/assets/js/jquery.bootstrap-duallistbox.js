  ...
  BootstrapDualListbox.prototype = {
    ...
    setBootstrap2Compatible: function(value, refresh) {
      ...
      if (value) {
        ...
        this.container.find('.clear1, .clear2').removeClass('btn-lunik btn-xs').addClass('btn-mini');
        this.container.find('input, select').removeClass('form-control');
        this.container.find('.btn').removeClass('btn-lunik');
        ...
        this.container.find('.clear1, .clear2').removeClass('btn-mini').addClass('btn-lunik btn-xs');
        this.container.find('input, select').addClass('form-control');
        this.container.find('.btn').addClass('btn-lunik');
